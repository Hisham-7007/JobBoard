                  ...
                  <div className="flex flex-col lg:flex-row lg:items-center justify-between mb-6 gap-6">
                    <div className="flex items-start space-x-6">
                      <div
                        ...
                        } rounded-2xl flex items-center justify-center text-white text-xl font-bold`}
                      >
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                      ...
                      {onJobClick ? (
                        <Button
                          ...
                          className="bg-gradient-to-r from-purple-500 to-pink-500 text-white px-8 py-3 rounded-xl hover:shadow-lg hover:shadow-purple-500/25 transition-all duration-300 transform hover:scale-105 font-medium flex items-center space-x-2"
                        >
                          <span>View</span>
